...
| --- | --- | --- | --- |
| **[ETH.ED — AI-Powered Web3 Learning Platform](https://github.com/AyuShetty/ethed-frontend)** | AI-powered Web3 learning platform with gamified lessons, ENS-based certificates, and smart contract micropayments. Next.js + AI + Ethereum. | `Next.js` · `TypeScript` · `AI` · `Ethereum` · `ENS` · `Smart Contracts` | [Repo](https://github.com/AyuShetty/ethed-frontend) · [Demo](https://ethed.xyz) |
| **[EIPSINSIGHT — Ethereum Governance Analytics](https://github.com/AvarchLLC/EIPsInsight)** | Ethereum governance analytics platform for tracking EIP lifecycles, governance signals, and stakeholder influence. Real-time dashboard with on-chain + off-chain data fusion. | `TypeScript` · `Next.js` · `React` · `Ethereum` · `The Graph` · `PostgreSQL` | [Repo](https://github.com/AvarchLLC/EIPsInsight) |
...
| **[ETHERWORLD IOS — Scalable iOS App Architecture](https://github.com/AyuShetty/EtherWorld_IOS)** | Designed the application architecture and modular structure for the EtherWorld iOS app — scalable navigation, API integration, and maintainable app structure. | `Swift` · `SwiftUI` · `Combine` · `Web3.swift` · `XCTest` · `Fastlane` | [Repo](https://github.com/AyuShetty/EtherWorld_IOS) |
...
| **Frontend & Interaction** | `Next.js` · `React` · `React Native` · `iOS / SwiftUI` · `Tailwind CSS` · `Framer Motion` · `Three.js / 3D Web` · `WebGL / Shaders` |
...
| **EIPSINSIGHT v2 — Real-time Governance Intelligence** | `15%` | Expand EIPsInsight to cover EOF, Verkle trees, and upcoming protocol upgrades. Add predictive governance signaling and stakeholder influence mapping. |
...
| Stars / forks | **4 / 2** |
| Commits in the latest period | **365** |
| Followers | **4** |
