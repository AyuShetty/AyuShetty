...
- **Tech:** Python, Ollama, Docker, Playwright, Open WebUI, Kubernetes, LangGraph
- **Highlights:**
  - Multi-node inference with automatic load balancing
  - Browser automation integrated into LLM workflows
  - Open WebUI compatible — drop-in replacement for cloud APIs
- **Repo:** [https://github.com/AyuShetty/local_ai_infrastructure](https://github.com/AyuShetty/local_ai_infrastructure)
...
- **Tech:** Python, Playwright, Ollama, LangGraph, Pydantic, YAML
- **Highlights:**
  - 95%+ success rate on benchmark automation tasks
  - Self-healing selector strategy (DOM + visual + LLM)
  - YAML workflow DSL — no code for common patterns
- **Repo:** [https://github.com/AyuShetty/ai_workflow_automation](https://github.com/AyuShetty/ai_workflow_automation)

---

### ethed
*AI-powered Web3 learning platform with gamified lessons, ENS-based certificates, and smart contract micropayments. Next.js + AI + Ethereum.*

- **Tech:** Next.js, TypeScript, AI, Ethereum, ENS, Smart Contracts, Tailwind CSS
- **Highlights:**
  - ENS-based verifiable certificates (Soulbound NFTs)
  - AI tutor with RAG over Ethereum documentation
  - Smart contract micropayments for content creators
- **Repo:** [https://github.com/AyuShetty/ethed-frontend](https://github.com/AyuShetty/ethed-frontend)

---

### eipsinsight
*Ethereum governance analytics platform for tracking EIP lifecycles, governance signals, and stakeholder influence. Real-time dashboard with on-chain + off-chain data fusion.*

- **Tech:** TypeScript, Next.js, React, Ethereum, The Graph, PostgreSQL, GitHub API, Discord API
- **Highlights:**
  - Tracks 200+ EIPs across lifecycle stages
  - Stakeholder influence mapping (on-chain + off-chain)
  - Real-time governance signal aggregation
- **Repo:** [https://github.com/AvarchLLC/EIPsInsight](https://github.com/AvarchLLC/EIPsInsight)

---

### facial_keygen
*Python-based biometric authentication system generating cryptographic keys from facial biometrics using computer vision and ML for post-quantum security research.*

- **Tech:** Python, OpenCV, MediaPipe, PyTorch, Cryptography, NumPy
- **Highlights:**
  - Novel biometric-to-crypto key derivation pipeline
  - Post-quantum secure key derivation (CRYSTALS-Dilithium compatible)
  - Fuzzy extractor with >99% reproduction rate
- **Repo:** [https://github.com/AyuShetty/facial_keygen](https://github.com/AyuShetty/facial_keygen)
...
- **Highlights:**
  - Sub-50ms gesture-to-action latency
  - 8 gesture classes with 95%+ accuracy
  - Zero external dependencies — runs fully offline
- **Repo:** [https://github.com/AyuShetty/airgesture](https://github.com/AyuShetty/airgesture)
...
- **Tech:** Swift, SwiftUI, Combine, Web3.swift, XCTest, Fastlane
- **Highlights:**
  - Zero-massive-view-controller architecture
  - Type-safe API layer with code generation
  - Web3 transaction signing flow with Secure Enclave
- **Repo:** [https://github.com/AyuShetty/etherworld_ios](https://github.com/AyuShetty/etherworld_ios)

---

### this_portfolio
*Immersive developer portfolio with a 3D dome gallery, scroll-driven animations, and an editorial bronze design system. Next.js + Three.js + custom design tokens.*

- **Tech:** Next.js, TypeScript, Three.js, React Three Fiber, GSAP, Tailwind CSS, Design Tokens
- **Highlights:**
  - Custom 3D dome gallery with 60fps mobile target
  - Editorial bronze design system (tokens + components)
  - Scroll-driven narrative animations
- **Repo:** [https://github.com/AyuShetty/ayushetty.me](https://github.com/AyuShetty/ayushetty.me)

---

### ayu_os
*A fictional operating system expressed through a GitHub profile. Component-driven SVG design system, automated build pipeline, and token-based theming.*

- **Tech:** Python, SVG, Jinja2, GitHub Actions, Design Tokens, SVGO
- **Highlights:**
  - 15+ reusable SVG primitives with validation
  - Fully automated daily stats refresh via GitHub Actions
  - WCAG 2.1 AA accessible SVGs
- **Repo:** [https://github.com/AyuShetty/AyuShetty](https://github.com/AyuShetty/AyuShetty)
...
Last Generated: 2026-07-28T10:28:36.078089Z
